...
public class Viwer {
    ...
    class LinkedList {
        ...
        public boolean isSymmetric() {
            ...
            if (currentOriginal != null || currentReversed != null) {
                return false; // Количество элементов в списках не совпадает, список не симметричный
            }

            return true; // Все элементы совпадают, список симметричный
        }
        ...
        public boolean canRemoveTwoElementsForSorted() {
            ...
            while (current.next != null) {
                ...
                if (current.data > current.next.data) {
                    ...
                    if (isListSortedAfterRemoval(current.next)) {
                        return true;
                    }
